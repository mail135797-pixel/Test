...
def generate_image(prompt, idx):
    ...
    try:
        ...
        # Note: If this model is a text-to-image model via generate_images
        try:
            ...
            print(f"Attempt with gemini-3-pro-image-preview failed: {e}")
            
            # Fallback to nano-banana-pro-preview just in case
            try:
                ...
                print(f"Attempt with nano-banana-pro-preview failed: {e2}")
                # Fallback to imagen-4.0 since I saw it in list
                print("Trying imagen-4.0-generate-001...")
                response = client.models.generate_images(
